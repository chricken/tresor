...
## Funktionsweise
Dieses Framework besteht aus einer Klasse, welche sowohl im Client als auch im Webworker importiert wird.

Im Worker werden Daten hinterlegt, welche dann über Methoden auf sichere Weise abgefragt und geändert werden können.
